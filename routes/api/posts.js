...
// @route   PUT api/posts/like/:id <- endpoint
// @desc    Like a post
// @access  Private (or private: You need to send a token to that route, in order for it to work.)
...
// @route   PUT api/posts/unlike/:id <- endpoint
// @desc    unlike a post
// @access  Private (or private: You need to send a token to that route, in order for it to work.)
...
// @route   POST api/posts/comment/:id <- endpoint
...
// @route   DELETE api/posts/comment/:id/:comment_id <- endpoint
// @desc    Delete comment
// @access  Private (or private: You need to send a token to that route, in order for it to work.)
