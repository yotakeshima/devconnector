...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      // Everytime a mongoDB method is used. Make sure to use await, because it returns a promise.
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      // UNSHIFT adds to the front of the array instead of the end...
